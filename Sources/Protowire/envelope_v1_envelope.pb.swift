...
public struct Envelope_V1_Envelope {
  ...
  public var error: Envelope_V1_AppError {
    get {return _error ?? Envelope_V1_AppError()}
    set {_error = newValue}
  }
...
public struct Envelope_V1_AppError {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envelope_V1_FieldError {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envelope_V1_Envelope: @unchecked Sendable {}
extension Envelope_V1_AppError: @unchecked Sendable {}
extension Envelope_V1_FieldError: @unchecked Sendable {}
...
extension Envelope_V1_Envelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "status"),
    2: .standard(proto: "transport_error"),
    3: .same(proto: "data"),
    4: .same(proto: "error"),
  ]
